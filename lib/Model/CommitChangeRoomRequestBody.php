...
/**
 * CommitChangeRoomRequestBody Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CommitChangeRoomRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommitChangeRoomRequestBody';
    ...
    protected static $openAPITypes = [
        ...
        'payments' => '\OpenAPI\Client\Model\PaymentRequestWithPhone[]'
    ];
    ...
    */
     ...
     *
     * @param string|null $change_reference_id Your optional identifier for the change being executed. Only unique per itinerary. Special characters (\"<\", \">\", \"(\", \")\", and \"&\") entered in this field will be re-encoded.
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\Model\PaymentRequestWithPhone[]|null
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\PaymentRequestWithPhone[]|null $payments payments
     *
     * @return self
     */
