...
/**
 * CreateItineraryRequestRoom Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateItineraryRequestRoom implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateItineraryRequestRoom';
    ...
    */
     ...
     * Sets given_name
     *
     * @param string $given_name First name of room guest. Max 60 characters. Special characters (\"<\", \">\", \"(\", \")\", and \"&\") entered in this field will be re-encoded.
     *
     * @return self
     */
     ...
     * Sets family_name
     *
     * @param string $family_name Last name of room guest. Max 60 characters. Special characters (\"<\", \">\", \"(\", \")\", and \"&\") entered in this field will be re-encoded.
     *
     * @return self
     */
