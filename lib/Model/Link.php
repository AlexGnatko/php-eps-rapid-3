...
class Link implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets method
     *
     * @param string|null $method The request method used to access the link.
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href The URL for the link. This can be absolute or relative.
     *
     * @return self
     */
     ...
     * Sets expires
     *
     * @param string|null $expires If the link expires, this will be the UTC date the link will expire, in ISO 8601 format.
     *
     * @return self
     */
