...
class Checkin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('_24_hour', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function get24Hour()
    {
        return $this->container['_24_hour'];
    }

    /**
     * Sets _24_hour
     *
     * @param string|null $_24_hour Present if the property has 24-hour check-in.
     *
     * @return self
     */
    public function set24Hour($_24_hour)
    {
        if (is_null($_24_hour)) {
            throw new \InvalidArgumentException('non-nullable _24_hour cannot be null');
        }
        $this->container['_24_hour'] = $_24_hour;
     ...
     * Sets begin_time
     *
     * @param string|null $begin_time The time at which a property begins to allow check-ins.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param string|null $end_time The time at which a property stops allowing check-ins.
     *
     * @return self
     */
     ...
     * Sets instructions
     *
     * @param string|null $instructions The property's check-in policy.
     *
     * @return self
     */
     ...
     *
     * @param string|null $special_instructions Any special instructions for checking into this property that may be specific to this property.
     *
     * @return self
     */
     ...
     * Sets min_age
     *
     * @param float|null $min_age The minimum age for a customer to be able to check-in at a property.
     *
     * @return self
     */
