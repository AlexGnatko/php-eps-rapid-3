 ...
 *
 * @category Class
 * @description The entire phone number must be represented across the three fields in this object.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Phone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets country_code
     *
     * @param string|null $country_code The numerical portion of the country code from the phone number. Do not include the leading '+' character.
     *
     * @return self
     */
     ...
     * Sets area_code
     *
     * @param string|null $area_code The area code of the phone number.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number The remaining digits of the phone number.
     *
     * @return self
     */
