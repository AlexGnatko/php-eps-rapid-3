...
class PhoneRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets country_code
     *
     * @param string $country_code The numerical portion of the country code from the phone number. Do not include the leading '+' character. Special characters (\"<\", \">\", \"(\", \")\", and \"&\") entered in this field will be re-encoded.
     *
     * @return self
     */
     ...
     * Sets area_code
     *
     * @param string|null $area_code The area code of the phone number. Special characters (\"<\", \">\", \"(\", \")\", and \"&\") entered in this field will be re-encoded.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string $number The remaining digits of the phone number. Special characters (\"<\", \">\", \"(\", \")\", and \"&\") entered in this field will be re-encoded.
     *
     * @return self
     */
