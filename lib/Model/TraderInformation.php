...
/**
 * TraderInformation Class Doc Comment
 *
 * @category Class
 ...
 */
class TraderInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TraderInformation';
    ...
    protected static $openAPITypes = [
        'traders' => '\OpenAPI\Client\Model\TraderDetailsInner[]',
    ...
    {
        $this->setIfExists('traders', $data ?? [], null);
    ...
    */
     ...
     * Gets traders
     *
     * @return \OpenAPI\Client\Model\TraderDetailsInner[]|null
     */
    public function getTraders()
    {
        return $this->container['traders'];
    }

    /**
     * Sets traders
     *
     * @param \OpenAPI\Client\Model\TraderDetailsInner[]|null $traders An array of traders.
     *
     * @return self
     */
    public function setTraders($traders)
    {
        if (is_null($traders)) {
            throw new \InvalidArgumentException('non-nullable traders cannot be null');
        }
        $this->container['traders'] = $traders;
     ...
     *
     * @param string $terms_and_conditions The url linking to the full text terms and conditions.
     *
     * @return self
     */
