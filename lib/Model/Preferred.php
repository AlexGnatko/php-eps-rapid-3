...
/**
 * Preferred Class Doc Comment
 *
 * @category Class
 * @description The preferred airport of the property.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Preferred implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Preferred';
    ...
    */
     ...
     *
     * @param string|null $iata_airport_code The airport's IATA code.
     *
     * @return self
     */
