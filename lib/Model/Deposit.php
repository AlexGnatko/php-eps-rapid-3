...
class Deposit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value The amount that must be paid as a deposit.
     *
     * @return self
     */
     ...
     * Sets due
     *
     * @param string|null $due The due date in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency for the deposit amount.
     *
     * @return self
     */
