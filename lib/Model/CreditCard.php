...
class CreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'card_options' => '\OpenAPI\Client\Model\CardOption[]',
        'merchant' => '\OpenAPI\Client\Model\CreditCardMerchant',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Gets card_options
     *
     * @return \OpenAPI\Client\Model\CardOption[]|null
     */
     ...
     * Sets card_options
     *
     * @param \OpenAPI\Client\Model\CardOption[]|null $card_options card_options
     *
     * @return self
     */
    public function setCardOptions($card_options)
    {
        if (is_null($card_options)) {
            throw new \InvalidArgumentException('non-nullable card_options cannot be null');
        }
     ...
     * Gets merchant
     *
     * @return \OpenAPI\Client\Model\CreditCardMerchant|null
     */
     ...
     * Sets merchant
     *
     * @param \OpenAPI\Client\Model\CreditCardMerchant|null $merchant merchant
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Display name of payment option.
     *
     * @return self
     */
