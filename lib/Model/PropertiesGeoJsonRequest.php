...
/**
 * PropertiesGeoJsonRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PropertiesGeoJsonRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PropertiesGeoJsonRequest';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The geometry type. The only supported type is `Polygon`
     *
     * @return self
     */
