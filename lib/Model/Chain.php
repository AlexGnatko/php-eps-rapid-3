 ...
 *
 * @category Class
 * @description An individual chain.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Chain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'brands' => 'array<string,\OpenAPI\Client\Model\Brand>'
    ];
    ...
    */
     ...
     * Gets brands
     *
     * @return array<string,\OpenAPI\Client\Model\Brand>|null
     */
     ...
     * Sets brands
     *
     * @param array<string,\OpenAPI\Client\Model\Brand>|null $brands Map of the chain's brands.
     *
     * @return self
     */
